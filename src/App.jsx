...
import ProductoShot from './pages/PS/ps.jsx'
import ValidadorBanners from './pages/Validadorbanners/Validadorbanners.jsx'
import './App.css'
  ...
  return (
      ...
      <>
        ...
        <Routes>
         ...
         <Route path="/ps" element={<ProductoShot />} />
         <Route path="/ValidadorBanners" element={<ValidadorBanners />} />
        </Routes>
        <Footer />
      </>
